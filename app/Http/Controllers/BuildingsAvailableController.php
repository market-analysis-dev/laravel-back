...
use App\Models\BuildingAvailability;
...
public function exportAvailability(ExportAvailabilityRequest $request): ApiResponse
{
    $validated = $request->validated();
    ...
    $availabilities->getCollection()->transform(function ($item) {
        return [
            ...
            'ba_abs_closing_date' => $item->abs_closing_date?->format('Y-m-d') ?? null,
