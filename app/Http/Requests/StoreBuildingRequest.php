...
class StoreBuildingRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'builder_id' => 'required|integer|exists:building_contacts,id',
            'industrial_park_id' => 'required|integer|exists:industrial_parks,id',
            'developer_id' => 'required|integer|exists:building_contacts,id',
            'owner_id' => 'required|integer|exists:building_contacts,id',
            'user_owner_id' => 'required|integer|exists:building_contacts,id',
            ...
            'new_construction' => 'required|boolean',
            'starting_construction' => 'required|boolean',
            ...
            'building_phase' => 'required|in:BTS,Expansion,Inventory,Construction,Planned,Sublease,Expiration',
