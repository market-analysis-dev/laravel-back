...
return new class extends Migration
{
    ...
    {
        Schema::create('buildings_available_log', function (Blueprint $table) {
            $table->id();
            $table->foreignId('building_available_id')->constrained('buildings_available');
    ...
    {
        Schema::dropIfExists('buildings_available_log');
    }
};
